...
[OAuth2](https://oauth.net/) définit plusieurs modes d'authentification; les modes sont appelés des Grant Types. Le Grant Type utilisé dans ce post est le grant "Implicit". 
...
* Toutes les requêtes Ajax du Front au Back doivent intégrer l'access token; le token porte les informations de connexion de l'utilisateur
