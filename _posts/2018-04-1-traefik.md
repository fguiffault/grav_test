...
Ce document vient dans la continuité de celui de [Patrick Easters](https://medium.com/@patrickeasters/using-traefik-with-tls-on-kubernetes-cb67fb43a948) pour remplacer la création des certificats via openssl par une création des certificats via letsencrypt.
